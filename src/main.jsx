...
const router = createBrowserRouter([
  {
    path: "/",
    element: <Layout_outlet />, // this line is to link the the url with layout_outlet section section where we are rendering outlet,header,footer

    children: [
      {
        path: "home",
        element: <Home />, // path means what url will show us or what we can write in url  after the destination of the url will be element
      },
      {
        path: "contact",
        element: <Contact_us />,
      ...
      },
      {
        ...
        element: <User_id />, // go to user_id component to understand
      },
    ],
  },
]);
